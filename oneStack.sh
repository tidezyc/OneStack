...
##  expect -c "spawn /usr/bin/scp  yuan@192.168.0.84:/home/yuan/precise-server-cloudimg-amd64-disk1.img .; expect {
##     \"password:\"; {
##    send \"yyhu\r\n\";
...
--floating_range=192.168.0.225/27 
--network_size=32
--flat_network_dhcp_start=192.168.0.40
--flat_injected=False
--force_dhcp_release
--iscsi_helper=tgtadm
...
sed -i -e "s/10.0.0.1/$IN_IP/g;s/192.168.0.40/$FLAT_IP/g;s/10.0.0/$IN_IP_PRE/g;" /etc/nova/nova.conf
## kvm or qemu?
...
## 设定floating IP
nova-manage floating create --ip_range=192.168.0.225/27
...
## nova add-floating-ip cloud01 192.168.0.226
nova show cloud01
